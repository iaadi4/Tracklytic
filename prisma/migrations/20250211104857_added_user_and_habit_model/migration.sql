...
-- CreateIndex
CREATE INDEX "HabitTracker_year_month_idx" ON "HabitTracker"("year", "month");

-- CreateIndex
CREATE UNIQUE INDEX "HabitTracker_habitId_year_month_key" ON "HabitTracker"("habitId", "year", "month");
